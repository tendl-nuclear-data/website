A minimal repository to demo the use of [Zenodo](https://zenodo.org) and GitHub pages to host the TENDL website.

For this proof of concept I have just uploaded the TENDL 2025 Application Library for Neutrons.
...
Zendo scales to store all the TENDL data and much more
